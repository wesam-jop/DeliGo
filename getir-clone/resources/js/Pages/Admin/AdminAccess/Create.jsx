...
export default function AdminAccessCreate({ users }) {
    ...
    return (
        <AdminLayout title={t('add_new_permission')}>
            <Head title={t('add_new_permission')} />
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-xl font-bold text-slate-900">{t('add_new_permission') || 'Add New Permission'}</h2>
                                <p className="text-sm text-slate-600">{t('add_phone_for_admin_access') || 'Add a new phone number to allow access to the admin dashboard'}</p>
                            </div>
                        </div>
                        <Link
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <p className="mt-1 text-xs text-slate-500">{t('phone_number_format_hint') || 'Enter phone number without symbols (e.g., 963111111111)'}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs text-slate-500">{t('disabled_permissions_cannot_access') || 'Disabled permissions cannot access the dashboard'}</p>
                        </div>
                        ...
                        <div className="flex items-center gap-4 pt-4">
                            ...
                            >
                                {processing ? (
                                    ...
                                    <>
                                        <span>{t('save_permission') || 'Save Permission'}</span>
