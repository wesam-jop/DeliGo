                        ...
                        <div className="bg-white rounded-lg shadow-sm p-6">
                            <div className="flex items-center">
                                ...
                                <div className="mr-4">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{stats.total_revenue} ل.س</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        {recentOrders.map((order) => (
                                            <div key={order.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                                ...
                                                <div className="text-right">
                                                    <p className="font-bold text-purple-600">{order.total_amount} ل.س</p>
                                        ...
                                        {topStores.map((store, index) => (
                                            <div key={store.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <p className="text-xs text-gray-500">{store.total_revenue} ل.س</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                    ...
                                    {monthlySales.slice(-12).map((sale, index) => (
                                        <div key={index} className="text-center">
                                            <div className="bg-purple-100 rounded-lg p-3 mb-2">
                                                <p className="text-sm font-medium text-purple-600">{sale.total_amount} ل.س</p>
                                                <p className="text-xs text-gray-600">{sale.orders_count} طلب</p>
                                            </div>
                                            <p className="text-xs text-gray-500">
                                                {new Date(sale.year, sale.month - 1).toLocaleDateString('ar-SA', { month: 'short' })}
                                            </p>
                                        </div>
                                    ))}
                                </div>
