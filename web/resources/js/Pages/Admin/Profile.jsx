                                    ...
                                    <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                                        <div>
                                            <p className="text-sm font-bold text-slate-900 flex items-center gap-2">
                                                ...
                                                {t('store_map_title') || 'حدد موقعك على الخريطة'}
                                            </p>
                                            <p className="text-xs text-slate-500">{t('store_map_subtitle') || 'انقر على الخريطة لتحديث الإحداثيات بدقة.'}</p>
                                        </div>
                                        <div className="flex flex-wrap gap-2">
                                            <button
                                                type="button"
                                                onClick={handleUseCurrentLocation}
                                                className="inline-flex items-center gap-2 rounded-full border border-purple-200 bg-purple-50 px-4 py-2 text-xs font-semibold text-purple-700 hover:bg-purple-100 transition-colors"
                                            >
                                                <LocateFixed className="w-4 h-4" />
                                                {t('store_map_use_location') || 'تحديد موقعي الحالي'}
                                            </button>
                                        </div>
                                    </div>
                                    <StoreLocationPicker
